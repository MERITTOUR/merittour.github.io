...
| 이바라키 · 시로사토 | `ibaraki` | 시로사토CC 호텔 | `lodge` |
| 이바라키 · 후쿠로다노타키 | `fukuroda` | 후쿠로다노타키CC 호텔 | `lodge` |
| 미야자키 · 국제공항CC · 레인보우CC | `miyazaki` | 국제공항CC 호텔 | `hotel` |
| | | 미야자키 시내 호텔 | `city` |
| 나가노 · 스가다이라 그린CC | `nagano` | 팔콜 츠마고이 리조트 | `hotel` |

골프장 사진은 지역마다 `golf` 하나입니다.
쿠알라룸푸르 닐라이스프링스 · 벳푸 무츠키 료칸 · 벳푸 그랜드 머큐어 벳푸 베이 리조트 & 스파는 **상시예약 기간 오픈 예정**이라
안내문 맨 아래에 이름만 두고 **사진 자리를 두지 않습니다**(2026-09 · 무츠키·그랜드 머큐어는 2026-09-07). 올려도 나타나지 않습니다.
무츠키 료칸은 이미 올린 사진(`mutsuki/ryokan/01~09.webp`)이 폴더에 그대로 있고, 상시예약 오픈 때 블록을 되살리면 다시 보입니다.
...
| 지역 | 숙소 | 골프장 |
|---|---|---|
| 구마모토 · 아소 야마나미 | [아소 프레스티지](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/prestige) · [히노키 스테이](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/hinoki-stay) · [소보 테라스](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/sobo-terrace) · [쿠쥬 프라이빗 타운](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/kuju) · [돔스테이](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/dome) · [야마나미 호텔](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/hotel) · [간지호텔](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/guernsey) · [시즈노야도 료칸](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/shizunoyado) | [골프장](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/kumamoto/golf) |
...
| 이바라키 · 시로사토 | [시로사토CC 호텔](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/ibaraki/lodge) | [골프장](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/ibaraki/golf) |
...
| 나가노 · 스가다이라 그린CC | [팔콜 츠마고이 리조트](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/nagano/hotel) | [골프장](https://github.com/MERITTOUR/merittour.github.io/upload/main/2027/photos/nagano/golf) |
